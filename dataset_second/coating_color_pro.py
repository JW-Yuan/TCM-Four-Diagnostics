...
if __name__ == "__main__":
    input_folder = "coating_color_dataset"  # 原始图片目录
    output_folder = "coating_color_img"  # 处理后的图片保存目录
    labels_folder = "coating_color_label"  # 标签保存目录
    category_map = COATING_COLOR_MAP
